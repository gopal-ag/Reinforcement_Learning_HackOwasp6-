...
while cap.isOpened():
    ...
    if results.pose_landmarks:
        ...
        print(left_shoulder.x,int(0.8*camera_width))
        if left_shoulder.x>0.98:
            cv2.putText(frame, f"About to exit", (15,70), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)

        # if right_shoulder.x>0.02:
        #     cv2.putText(frame, f"Towards the Right", (15,70), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
